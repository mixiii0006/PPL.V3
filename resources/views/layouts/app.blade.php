...
@include('layouts.navigation')
            ...
            >
              <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
                <form action="{{ route('jadwal_ruangan.index') }}" method="GET"class="md:hidden mb-2">
                ...
                {{-- @auth
                  @php
                      // Cek apakah user yang sedang login memiliki email yang sama dengan NIP di tabel dosen
                      $isDosen = \App\Models\Dosen::where('nip', Auth::user()->email)->exists();
                  @endphp

                  @if($isDosen)
                      <li>
                          <a
                              href="{{ route('jadwal_dosen.index') }}"
                          ...
                          >
                              ...
                              <span class="ml-3">Jadwal Saya</span>
                          </a>
                      </li>
                  @endif
                @endauth --}}
                ...
                @auth
                    @if(Auth::user()->role=='admin'|| Auth::user()->role == 'operator')
                      <li>
                        <li>
                            <a
                              href="{{ route('ruangan_tersedia.index') }}"
                              class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                              >
                              <svg class="w-6 h-6 text-gray-600 dark:text-gray-400"  aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                              ...
                              <span class="ml-3">Ruangan Tersedia</span></a
                            >
                          </li>
                          <li>
                            <a
                              href="{{ route('tambah_ruangan.index')}}"
                              class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                              >
                              <svg class="w-6 h-6 text-gray-600 dark:text-gray-400"  aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd" d="M20 10H4v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8ZM9 13v-1h6v1a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1Z" clip-rule="evenodd"/>
                              ...
                              <span class="ml-3">Manajemen Ruangan </span></a
                            >
                          </li>
                        <li>
                            <a
                              href="{{ route('log_ruangan.index') }}"
                              class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                              >
                              <svg class="w-6 h-6 text-gray-600 dark:text-gray-400"  aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd" d="M20 10H4v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8ZM9 13v-1h6v1a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1Z" clip-rule="evenodd"/>
                              ...
                              <span class="ml-3">Log Ruangan</span></a
                            >
                          </li>
                        <li>
                            <a
                              ...
                              <span class="ml-3">Pemetaan Mata Kuliah</span></a
                            >
                          </li>
