    ...
    <div class="flex flex-wrap justify-between items-center">
      <div class="flex justify-start items-center">
        ...
        <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
          <span class="self-center text-lg font-extrabold whitespace-nowrap  text-blue-500 dark:text-blue-500">MedSched</span>
        </a>

        <form action="{{ route('jadwal_ruangan.index') }}" method="GET" class="hidden md:block md:pl-2">
